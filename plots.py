...
gamma_list = [0.02, 0.006, 0.004, 0.0003]
...
def model_predict(size = 8):
    ...
    best_acc = -999
    best_h_params = None
    print("C: Gamma: Training_Accuracy: Dev_Accuracy: Test_Accuracy\n")
    ...
    print("Combinations of Hyper_parameters that we found best:", end = " ")
    print(cur_parameters)
